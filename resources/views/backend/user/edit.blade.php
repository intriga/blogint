              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('/admin/user/' . $user->id.'/edit') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="password" class="form-control" id="inputName2" name="password" value="{{ $user->password }}">
                        </div>
                      </div>
                      <div class="form-group row">
